...
?>
                    ...
                    <div class="swiper-slide dark" style="background-image: url('images/campercrate.bg.jpg');">
                        <div class="container clearfix">
                            <div class="slider-caption slider-caption-center">
                                <h2 data-caption-animate="fadeInUp" style="color: #FF6600;">Welcome to Canvas</h2>
        ...
        <section id="content">
            ...
            <div class="content-wrap" style="padding: 30px 0;">
                ...
                <div class="container clearfix">
                    ...
                    <div class="divcenter center clearfix nomargin" style="max-width: 900px;">
                        <!-- <img class="nomargin" src="images/logo-side.png" alt=""> -->
                        <h1>We are <span>Hunt Can</span>.</h1>
                        <h2 style="font-weight: 300;">Boxes are boring. Be different. Every monthly subscription comes with a can full of gear. We also include gear that doesn't fit in a can.</h2>
                        <a href="#" class="button button-flat button-dark button-large ">Give As A Gift</a>
                        <a href="#" class="button button-flat button-large">Get Started</a>
                    </div>
        ...
        <section id="content">
            ...
            <div class="content-wrap" style="padding: 30px 0;">
                ...
                <div class="promo promo-full bottommargin-lg" style="background-image: url('images/parallax/3.jpg');" data-stellar-background-ratio="0.4">
                    <div class="container clearfix">
            ...
            <div class="content-wrap" style="padding: 30px 0;">
                ...
                <div class="container clearfix">
                    ...
                    <div class="divcenter center clearfix nomargin" style="max-width: 900px;">
                        <!-- <img class="nomargin" src="images/logo-side.png" alt=""> -->
                        <h1>We are <span>Hunt Can</span>.</h1>
                        <h2 style="font-weight: 300;">Hunt Can equips hunters with a monthly subscription of all kinds of gear for every situation.</h2>
                        <a href="#" class="button button-flat button-dark button-large ">Give As A Gift</a>
                        <a href="#" class="button button-flat button-large">Get Started</a>
                    </div>
                ...
                <div class="section bottommargin-lg" style="background-image: url('images/parallax/3.jpg'); padding: 100px 0;" data-stellar-background-ratio="0.3">
